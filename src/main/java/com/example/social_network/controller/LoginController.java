...
public class LoginController {
    ...
    public void handleLogin(ActionEvent actionEvent) throws IOException {
        ...
        try {
            ...
            if (user.isEmpty()){
                ...
                FXMLLoader fxmlLoader1 = new FXMLLoader(LoginController.class.getResource("../fxml/userPage.fxml"));
    ...
    public void handleCreateNewAccount(ActionEvent actionEvent) throws IOException {
        FXMLLoader loader = new FXMLLoader(LoginController.class.getResource("../fxml/newAccount.fxml"));
